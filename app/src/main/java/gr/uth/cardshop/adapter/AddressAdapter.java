...
public class AddressAdapter extends RecyclerView.Adapter<AddressAdapter.ViewHolder> {
    ...
    private AddressRemoved addressRemoved;

    public AddressAdapter(Context applicationContext, List<Address> mAddressList, SelectedAddress selectedAddress, AddressRemoved addressRemoved) {
        this.applicationContext = applicationContext;
        this.mAddressList = mAddressList;
        this.selectedAddress = selectedAddress;
        this.addressRemoved = addressRemoved;
                        ...
                        .collection("Address").document(mAddressList.get(position).getDocId()).delete().addOnCompleteListener(new OnCompleteListener<Void>() {
                            ...
                            public void onComplete(@NonNull Task<Void> task) {
                                if(task.isSuccessful()) {
                                    ...
                                    addressRemoved.onAddressRemoved(mAddressList);
    ...
    public interface AddressRemoved{
       void onAddressRemoved(List<Address> addressList);
    }
}
