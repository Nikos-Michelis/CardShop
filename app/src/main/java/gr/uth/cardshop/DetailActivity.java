                ...
                if (user.isEmailVerified()) {
                    ...
                    if (feature != null) {
                        ...
                        if(qnt >= 0) {
                            ...
                            //Toast.makeText(DetailActivity.this, "ID"+feature.getProductId(), Toast.LENGTH_SHORT).show();
                    ...
                    if (bestSell != null) {
                        ...
                        if(qnt >= 0) {
                            ...
                            Toast.makeText(DetailActivity.this, "ID"+bestSell.getProductId(), Toast.LENGTH_SHORT).show();
                            Map<String, Object> mMap = new HashMap<>();
                    ...
                    if (items != null) {
                        ...
                        if(qnt >= 0) {
                            ...
                            //Toast.makeText(DetailActivity.this, "ID"+items.getProductId(), Toast.LENGTH_SHORT).show();
                            Map<String, Object> mMap = new HashMap<>();
                ...
                if (user.isEmailVerified()) {
                    ...
                    if (items != null) {
                        ...
                        documentReference.set(mMap, SetOptions.merge()).addOnSuccessListener(new OnSuccessListener<Void>() {
                            ...
                            @Override
                            public void onSuccess(Void unused) {
                                //Toast.makeText(DetailActivity.this, "insert or update", Toast.LENGTH_SHORT).show();
                                Toast.makeText(DetailActivity.this, "Item Added to Wishlist", Toast.LENGTH_SHORT).show();
                            }
                        }).addOnFailureListener(new OnFailureListener() {
                            @Override
