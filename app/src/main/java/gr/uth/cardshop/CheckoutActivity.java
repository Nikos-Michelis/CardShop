...
public class CheckoutActivity extends AppCompatActivity {
    ...
    private static final String BACKEND_URL = "Enter Your Own URL Here"//Heroku backend
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //Toast.makeText(this, "name "+fullName, Toast.LENGTH_SHORT).show();
        //Toast.makeText(this, "address "+Email, Toast.LENGTH_SHORT).show();
        //Toast.makeText(this, "phone "+Phone, Toast.LENGTH_SHORT).show();
        //Configure the SDK with your Stripe publishable key so it can make requests to Stripe
        stripe = new Stripe(getApplicationContext(),Objects.requireNonNull("Enter Your Own Key"));
        startCheckout();
    }
